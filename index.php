...
<div class="container input-group mb-3">
    <form action="index.php" method="post">
        <input type="text" name="nameInput" placeholder="Name" id="nameInput" autofocus>
...
<script type="text/javascript" src="signin.js">countDown()</script>
...
<!-- https://stackoverflow.com/questions/2663443/need-to-loop-through-a-php-array-in-javascript -->